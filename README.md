...
Scope: the **development execution plane** — CI jobs and dev agent work on our own iron. Sandboxing inside a product's own runtime is a separate design; the boundary is recorded in references.md ("Not this repo's decision").
...
- Runner controller: a thin JIT provisioner (default shape) vs myshoes + shoes-microsandbox; actions-runner-controller rejected — see references.md, "Controllers".
